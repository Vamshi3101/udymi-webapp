...
<div className="container py-5 text-bg-info">
      <h2 className="text-dark  text-center mb-4 text-uppercase">not a registered user?</h2>
      ...
      <h4 className="mt-4 text-dark"><u>Why Register as a Member</u></h4>
      <p>
      ...
      <h4 className="mt-4 text-dark"><u>Steps of registration</u>:</h4>
      <ol>
        ...
        <div className="container py-5 text-dark">
          <h4 className="text-dark  text-center mb-4 text-uppercase"><u>Eligibility for the Registration on DPIIT</u></h4>
